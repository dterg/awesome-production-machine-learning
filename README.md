...
* [InterpretML](https://interpret.ml/) ![](https://img.shields.io/github/stars/InterpretML/interpret.svg?style=social) - InterpretML is an open-source package for training interpretable models and explaining blackbox systems. Supports glassbox techniques such as: (i) Explainable Boosting; (ii) Decision Tree; and (iii) Logistic Regression, and black box explainers such as: (i) SHAP; (ii) LIME; (iii) Morris Sensitivity Analysis; and (iv) Partial Dependence.
...
* [Language Interpretability Tool (LIT)](https://github.com/PAIR-code/lit) ![](https://img.shields.io/github/stars/PAIR-code/lit.svg?style=social) - A visual and interactive model-understanding tool for NLP models by Google's PAIR. Capabilities include: local explanations with salience maps and attention, counterfactual generation, comparison of models, etc.  
...
* [CML](https://github.com/iterative/cml) ![](https://img.shields.io/github/stars/interactive/cml.svg?style=social) - open-source library for implementing continuous integration & delivery (CI/CD) in machine learning projects. Use it to automate parts of your development workflow, including model training and evaluation, comparing ML experiments across your project history, and monitoring changing datasets.
...
* [Ludwig](https://github.com/uber/ludwig) ![](https://img.shields.io/github/stars/uber/ludwig.svg?style=social) - low-code library for training and evaluation of deep learning models.
...
* [fastAPI](https://github.com/tiangolo/fastapi) ![](https://img.shields.io/github/stars/tiangolo/fastapi?style=social) - Python web-framework for building asynchronous web-services. Similar to flask but enforces typing, automates documentation with OpenAPI standards, 
* [flask](https://github.com/pallets/flask) ![](https://img.shields.io/github/stars/pallets/flask.svg?style=social) - Generic python micro-framework for building web-services.
...
* [CheckList](https://github.com/marcotcr/checklist) ![](https://img.shields.io/github/stars/marcotcr/checklist.svg?style=social) Testing NLP models with behavioral tests that include automatically generated adversarial attacks.
...
* [TextAttack](https://github.com/QData/TextAttack) ![](https://img.shields.io/github/stars/QData/TextAttack.svg?style=social) - python framework for adversarial attacks, data auggmentation and model training in NLP. 
* [~~TextFool~~](https://github.com/bogdan-kulynych/textfool) ![](https://img.shields.io/github/stars/bogdan-kulynych/textfool.svg?style=social) - **DEPRECATED** (see Trickster) ~~plausible looking adversarial examples for text generation.~~ 
